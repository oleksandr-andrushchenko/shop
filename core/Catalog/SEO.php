...
//        }
    ...
    protected function addPriceParams()
    {
        ...
        if ($name) {
            $name[] = $this->app->translator->makeText('catalog.currency_' . $this->app->config->catalog->currency('RUB'));
...
//        }
    ...
    public function manageBreadcrumbs($h1ParamsSize, Layout $view)
    {
        ...
        if ($categoryId) {
            $view->addBreadcrumb($this->app->translator->makeText('catalog.catalog'), (string)new URI);
            ...
            if (0 == $h1ParamsSize) {
                $categoryBreadcrumb = $this->app->translator->makeText('catalog.catalog');
            } else {
                $view->addBreadcrumb($this->app->translator->makeText('catalog.catalog'), (string)new URI);
                $categoryBreadcrumb = '';
            }
