...
CREATE TABLE `import_history` (
  ...
  `count_total` int(5) unsigned DEFAULT NULL,
  `count_filtered_filter` int(5) unsigned DEFAULT NULL,
  `count_filtered_modifier` int(5) unsigned DEFAULT NULL,
  `count_skipped_unique` int(5) unsigned DEFAULT NULL,
  `count_skipped_updated` int(5) unsigned DEFAULT NULL,
...
--
-- Table structure for table `item_attribute_value`
--
